...
name.innerHTML = name.innerHTML + " Ulises Sahlin"
...
// Tu código acá:
let listener = document.querySelector('#addButton')
 listener.addEventListener('click',addToDo)
